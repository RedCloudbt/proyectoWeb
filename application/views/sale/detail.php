            ...
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col-lg-7 col-7">
                  <h5 class="h3">Ventas Cloud Art</h5>
                  <div class="h5 font-weight-400">
                    Zempoala el Cerrito Cloud Art 1001<br/>Teléfono: 7714340982
                  </div>
                </div>
                ...
                <div class="col-lg-6 pt-3">
                  <h5>Nombre(s) y Apellidos: <span class="font-weight-light"><?php echo $sale->name; ?></span></h5>
                  <h5><?php echo $sale->type_document; ?>: <span class="font-weight-light"><?php echo $sale->num_document; ?></span></h5>
                  <h5>Correo: <span class="font-weight-light"><?php echo $sale->email; ?></span></h5>
