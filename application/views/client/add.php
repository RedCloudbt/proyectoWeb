                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phoneNumber" class="form-control <?php echo form_error('phoneNumber') ? 'is-invalid':''?>" placeholder="Teléfono/Celular del cliente"  value="<?php echo set_value('phoneNumber'); ?>">
                                    <div class="invalid-feedback"><?php echo form_error('phoneNumber'); ?></div>
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label">Correo</label>
                                    <input type="text" name="email" class="form-control <?php echo form_error('email') ? 'is-invalid':''?>" placeholder="Correo electrónico del cliente"  value="<?php echo set_value('email'); ?>">
