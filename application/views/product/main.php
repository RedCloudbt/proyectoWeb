...
<div class="header bg-primary pb-6">
    ...
    <div class="header-body">
        ...
        <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Pinturas</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>"><i class="fas fa-home"></i></a></li>
                <li class="breadcrumb-item active">Pinturas</a></li>
            </ol>
            </nav>
        </div>
        <div class="col-lg-6 col-5 text-right">
            <a href="<?php echo base_url(); ?>nuevo-producto" class="btn btn-sm btn-neutral">Nueva</a>
        </div>
        </div>
    </div>
    </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Lista de Pinturas</h3>
            </div>
            <!-- Light table -->
