            ...
            <div class="card">
                ...
                <form action="<?php echo base_url();?>nuevo-usuario/save" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control <?php echo form_error('email') ? 'is-invalid':''?>" placeholder="Correo electrónico del usuario"  value="<?php echo set_value('email'); ?>">
