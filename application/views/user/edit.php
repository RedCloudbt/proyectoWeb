            ...
            <div class="card">
                ...
                <form action="<?php echo base_url();?>usuario/update/<?php echo $id; ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control <?php echo form_error('email') ? 'is-invalid':''?>" placeholder="Correo del usuario"  value="<?php echo form_error('email') ? set_value('email'): $email; ?>">
