        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              SISTEMA DE VENTAS POR<br/>
              &copy; 2020 <a href="#" class="font-weight-bold ml-1" target="_blank">CLOUD´S TEAM</a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              Cloud Art <br/>
              &copy; 2020 <a href="#" class="font-weight-bold ml-1" target="_blank">Todos los Derechos Reservados</a>
            </div>
          </div>
        </div>
      </footer>
