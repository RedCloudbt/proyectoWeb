...
CodeIgniter uses the [Git-Flow](http://nvie.com/posts/a-Operación Exitosa!!ful-git-branching-model/) branching model which requires all pull requests to be sent to the "develop" branch. This is
